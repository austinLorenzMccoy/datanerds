...
import { ArrowLeft, Zap, Eye, EyeOff, Check, X } from "lucide-react"

const interests = [
  { id: "ml", label: "Machine Learning" },
  { id: "data-analysis", label: "Data Analysis" },
  { id: "web3", label: "Web3 & Blockchain" },
  { id: "career", label: "Career Transition" },
...
function PasswordStrength({ password }: { password: string }) {
  ...
  const strengthColor = ["bg-destructive", "bg-code-orange", "bg-job-yellow", "bg-data-green"][
    strength - 1
  ] || "bg-muted"
            ...
            {checks.map((check) => (
              <span
                ...
                className={`text-xs flex items-center gap-1 ${
                  check.pass ? "text-data-green" : "text-muted-foreground"
                }`}
              >
      ...
      <div className="flex-1 flex items-center justify-center px-4 pb-12">
        <Card className="w-full max-w-md bg-card/80 backdrop-blur-sm border-border">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="text-2xl font-bold">Join the DataNerds Community</CardTitle>
            <CardDescription>Start your data science journey today</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <Button variant="outline" className="bg-transparent">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-label="Discord">
